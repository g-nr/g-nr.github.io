...
As you can see, the `toString()` is in http://www.yaml.org/spec/1.2/spec.html[YAML]footnote:[Ben-Kiki, et al (2009). YAML Ain’t Markup Language (YAML™) Version 1.2. Online. Available at: http://www.yaml.org/spec/1.2/spec.html. Accessed Jul. 2016], concise and readable to a human and in code.
