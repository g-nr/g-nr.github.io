...
At a high level, different Microservices strategies have a lot in common.  They subscribe to the same ideals.
...
We have shown how easy it is to test and debug our components, but how do we turn these into services.  This is coming up in https://vanilla-java.github.io/2016/03/24/Microservices-in-the-Chronicle-world-Part-2.html[Part 2].
