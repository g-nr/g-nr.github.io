...
Micro-services is a buzz word at the moment. Is it really something orginal or based on established best practices. There are some disadvantages to the way micro-services have been implemented but can these be solved?
