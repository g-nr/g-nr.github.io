...
NOTE: There is a step in latency at around 10 million message per second jumps as the message start to batch. At rates below this, each message can be sent individually.
